...
#define DELTA_DIAGONAL_ROD 227 // mm (215)

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 179 // mm (137.0) 
...
#define MANUAL_Z_HOME_POS 260.9  // For delta: Distance between nozzle and print surface after homing.
...
#define Z_PROBE_OFFSET {0, 12.5, -21.4, 0}  // (0, 14, -6.5, 0) X, Y, Z, E distance between hotend nozzle and deployed bed leveling probe.(0,19,-8,0)
